...
Rectangle {
    ...
    Text {
        ...
        color: wifiWidget.isWiredConnected ? Colors.blue : (wifiWidget.isWifiOn ? Colors.fg : Colors.grey0)
    }
    MouseArea {
        anchors.fill: parent
        ...
        onClicked: {
            ...
            if (wifiPopup.visible) refreshNetwork.running = true
        }
    }
    ...
    Process {
        ...
        stdout: SplitParser {
            onRead: data => { refreshNetwork.fullOutput += data + "\n"; }
        }
        onExited: {
            ...
            if (sections.length >= 3) {
                ...
                if (linesRadio.length > 0) wifiWidget.isWifiOn = linesRadio[0].trim() === "enabled";
                ...
                for (let i = 0; i < linesWifi.length; i++) {
                    ...
                    if (parts.length >= 3) {
                        ...
                        if (ssid && !seenSsids[ssid]) {
                            seenSsids[ssid] = true;
                            wifiModel.append({ "active": active, "ssid": ssid, "bssid": bssid, "expanded": false });
                        }
                    }
                }
            }
    ...
    PopupWindow {
        ...
        Rectangle {
            ...
            onActiveFocusChanged: { if (!activeFocus) wifiPopup.visible = false }
            Column {
                ...
                Row {
                    ...
                    Text {
                        text: "󰑐" 
                        color: Colors.blue; font.pixelSize: 16; font.family: "JetBrainsMono Nerd Font"
                        anchors.verticalCenter: parent.verticalCenter
                        MouseArea { anchors.fill: parent; cursorShape: Qt.PointingHandCursor; onClicked: refreshNetwork.running = true }
                    }
                }
                ...
                ListView {
                    ...
                    delegate: Rectangle {
                        ...
                        Item {
                            ...
                            Rectangle {
                                ...
                                MouseArea {
                                    ...
                                    onClicked: {
                                        if (model.active) {
                                            wifiModel.setProperty(index, "active", false);
                        ...
                        Row {
                            ...
                            Rectangle {
                                width: 125; height: 24; radius: 4
                                color: Colors.bg0; border.color: Colors.bg3; border.width: 1
                                anchors.verticalCenter: parent.verticalCenter
                                
                                TextInput {
                                    id: passInput
                                    anchors.fill: parent; anchors.margins: 6
                                    color: Colors.fg; font.pixelSize: 11
                            ...
                            Rectangle {
                                width: 45; height: 24; radius: 4; color: Colors.blue
                                anchors.verticalCenter: parent.verticalCenter
                                Text { anchors.centerIn: parent; text: "Go"; color: Colors.bg0; font.bold: true; font.pixelSize: 11 }
