...
Rectangle {
    ...
    Process {
        ...
        stdout: SplitParser {
            onRead: data => {
                if (data === "gtk")
                    dashWidget.gtkEnabled = true;
                if (data === "zed")
                    dashWidget.zedEnabled = true;
            }
        }
    }
    ...
    Timer {
        ...
        running: true
        onTriggered: {
            if (dashWidget.gtkEnabled)
                dashWidget.applyGtk();
            if (dashWidget.zedEnabled)
                dashWidget.applyZed();
        }
    }
  ...
  "themes":[
    ...
    Process {
        ...
        stdout: SplitParser {
            onRead: data => {
                ...
                if (parts.length >= 4) {
                    dashWidget.briPercent = parseInt(parts[3].replace("%", ""));
                }
            }
        }
    }
    ...
    Process {
        ...
        stdout: SplitParser {
            onRead: data => {
                if (data.trim() !== "")
                    dashWidget.cpuUsage = parseFloat(data).toFixed(1) + "%";
            }
        }
    }
    ...
    Timer {
        ...
        onTriggered: {
            ...
            if (dashWidget.mediaStatus === "Playing" && !mediaPosWatcher.running)
    ...
    Component {
        ...
        Rectangle {
            ...
            Timer {
                ...
                onTriggered: cardRoot.osdExpired = true
            }
            ...
            Row {
                ...
                Column {
                    ...
                    Text {
                        ...
                        maximumLineCount: cardRoot.isOsd ? 3 : 10
    ...
    PanelWindow {
        ...
        Rectangle {
            ...
            width: 380
            height: 810
            color: Qt.alpha(Colors.bg0, 0.80)
            ...
            Column {
                            ...
                            Item {
                                ...
                                Row {
                                    ...
                                    Rectangle {
                                        ...
                                        scale: hoverPrev.pressed ? 0.9 : 1.0
                                        Behavior on scale {
                                            NumberAnimation {
                                                duration: 100
                                            }
                                    ...
                                    Rectangle {
                                        ...
                                        radius: 18
                                        color: Colors.blue
                                        scale: hoverPlay.pressed ? 0.9 : 1.0
                                        Behavior on scale {
                                            NumberAnimation {
                                                duration: 100
                                            }
                                    ...
                                    Rectangle {
                                        ...
                                        scale: hoverNext.pressed ? 0.9 : 1.0
                                        Behavior on scale {
                                            NumberAnimation {
                                                duration: 100
                                            }
                ...
                Item {
                    ...
                    Item {
                        ...
                        Row {
                            ...
                            Text {
                                text: {
                                    if (dashWidget.isMuted || dashWidget.volPercent === 0)
                                        return "󰝟";
                                    if (dashWidget.volPercent < 33)
                                        return "󰕿";
                                    if (dashWidget.volPercent < 66)
                                        return "󰖀";
                                    return "󰕾";
                                }
                                color: Colors.blue
                    ...
                    Slider {
                        ...
                        onMoved: {
                            if (dashWidget.audio)
                                dashWidget.audio.volume = value / 100.0;
                        }
                        onPressedChanged: {
                            if (!pressed)
                        ...
                        MouseArea {
                            ...
                            onWheel: wheel => {
                                ...
                                if (dashWidget.audio)
                                    dashWidget.audio.volume = newVol / 100.0;
                ...
                Item {
                    ...
                    Item {
                        ...
                        Row {
                            ...
                            Text {
                                text: {
                                    if (dashWidget.briPercent < 33)
                                        return "󰃞";
                                    if (dashWidget.briPercent < 66)
                                        return "󰃟";
                                    return "󰃠";
                                }
                                color: Colors.orange
                    ...
                    Slider {
                        ...
                        onMoved: {
                            dashWidget.briPercent = Math.round(value);
                        }
                        onPressedChanged: {
                            if (!pressed)
                ...
                Row {
                    ...
                    Rectangle {
                        ...
                        MouseArea {
                            anchors.fill: parent
                            cursorShape: Qt.PointingHandCursor
                            onClicked: dashWidget.activeTab = 0
                        }
                    }
                ...
                Item {
                    ...
                    Item {
                        anchors.fill: parent
                        visible: dashWidget.activeTab === 0
                        Rectangle {
                            width: 70
                            height: 24
                            radius: 4
                    ...
                    Item {
                        anchors.fill: parent
                        visible: dashWidget.activeTab === 1
                        Rectangle {
                            width: 70
                            height: 24
                            radius: 4
                        ...
                        ListView {
                            ...
                            delegate: Item {
                                ...
                                Timer {
                                    id: copySuccessTimer
                                    interval: 1500
                                    onTriggered: clipModel.setProperty(index, "justCopied", false)
                                }
                                ...
                                Row {
                                    ...
                                    Rectangle {
                                        ...
                                        Text {
                                            anchors.centerIn: parent
                                            text: "󰆴"
                                            color: delMouse.containsMouse ? Colors.bg0 : Colors.grey1
                                            font.pixelSize: 13
                                            font.family: "JetBrainsMono Nerd Font"
                                        }
                                        MouseArea {
    ...
    PanelWindow {
        ...
        Rectangle {
            ...
            MouseArea {
                anchors.fill: parent
            } // Prevent clicks falling through to the background
            ...
            Column {
                ...
                Row {
                    ...
                    Rectangle {
                        ...
                        border.color: dashWidget.gtkEnabled ? Colors.green : Colors.bg2
                        border.width: 1
                        Text {
                            anchors.centerIn: parent
                            text: "GTK Apps"
                            color: dashWidget.gtkEnabled ? Colors.bg0 : Colors.fg
                            font.bold: true
                            font.pixelSize: 13
                        }
                        MouseArea {
                    ...
                    Rectangle {
                        ...
                        border.color: dashWidget.zedEnabled ? Colors.green : Colors.bg2
                        border.width: 1
                        Text {
                            anchors.centerIn: parent
                            text: "Zed Editor"
                            color: dashWidget.zedEnabled ? Colors.bg0 : Colors.fg
                            font.bold: true
                            font.pixelSize: 13
                        }
                        MouseArea {
