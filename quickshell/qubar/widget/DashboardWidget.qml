...
`;
  ...
  "themes":[
    ...
    property var actionModel:[
        ...
        { name: "Logout", icon: "󰍃", cmd: "hyprctl dispatch 'hl.dsp.exit()'", color: Colors.orange },
    ...
    PanelWindow {
        ...
        Rectangle {
            ...
            color: Qt.alpha(Colors.bg0, 0.80); border.color: Colors.bg2; border.width: 1; radius: 16
            focus: true
